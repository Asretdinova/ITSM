...
$this->registerMetaTag(['property' => 'og:url ', 'content' => 'https://itsm.uz/uz/about-media/view?id=' . $model->id], 'og:url');
...
$this->params['breadcrumbs'][] = ['label' => Yii::t('main', 'Mass Media About Us'), 'url' => ['index']];
...
<div class="sharethis-inline-share-buttons" data-url="https://itsm.uz/uz/about-media/view?id=" <?=$model->id?>></div>